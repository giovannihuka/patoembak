...
<div class="container">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="" style="font-size: 20px; font-weight: bold;"><?php echo $site_name; ?></a>
	</div>
	...
	<div class="navbar-collapse collapse">
		...
		<ul class="nav navbar-nav">
				...
				<?php if (empty($parent_params['children'])): ?>
					...
					<li <?php if ($active) echo 'class="active"'; ?>>
						<a href='<?php echo $parent_params['url']; ?>'
							<?php if (!empty($parent_params['target'])) echo 'target="'.$parent_params['target'].'"'; ?> 
							>
			...
			<?php if ($this->ion_auth->logged_in()): ?>
				...
				<!-- <li><a>You are logged in as <?php echo $user->first_name; ?> <?php echo $user->last_name; ?></a></li> -->
			<?php else: ?>
