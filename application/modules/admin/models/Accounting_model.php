...
class Accounting_model extends MY_Model
{
    ...
    function json($contract_id = NULL) {
        $this->datatables->select('id,in_out,category_id,activity_id,activity_date,amount,description,status_data,create_userid,update_userid,create_time,update_time');
