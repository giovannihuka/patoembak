...
class Ref_charttype extends Admin_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('Ref_charttype_model');
    ...
    private $script = array(
        ...
        'assets/dist/admin/ref_charttype.js',
    ); 
    ...
    public function index()
    {
        ...
        $this->mPageTitle = 'Informasi Tipe Chart of Accounts'; 
        $this->render('ref_charttype/ref_charttypes_list');
    } 
    ...
    public function json() {
        ...
        */
        ...
        // if ($contractid !== '1')
        // {
        //     echo $this->Ref_charttype_model->json($contractid);
        // }
        // else
        // {
            echo $this->Ref_charttype_model->json();
        // }
    ...
    public function read($id)
    {
        ...
        $row = $this->Ref_charttype_model->get_by_id($id);
        ...
        $this->mViewData['ref_charttype'] = $data;
        $this->mPageTitle = 'Tipe Chart of Accounts';
        $this->mViewData['form'] = $form;
        $this->render('ref_charttype/ref_charttypes_read');
    }
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Ref_charttype_model->set_primary_key('id');
            $this->Ref_charttype_model->delete($id);
            $this->Ref_charttype_model->set_primary_key('id');
            $this->session->set_flashdata('message', 'Delete Record Success');
            redirect(site_url('admin/ref_charttype'));
        } else {
    ...
    public function create()
    {
        ...
        $this->mViewData['ref_charttype'] = $this->Ref_charttype_model->get_all();
        $this->mPageTitle = 'Registrasi Tipe Chart of Accounts';
        $this->mViewData['form'] = $form;
        $this->render('ref_charttype/ref_charttypes_form');
    ...
    if ($row)
    {
        ...
        $this->mViewData['ref_charttype'] = $data;
        $this->mPageTitle = 'Ubah Tipe Chart of Accounts';
        $this->mViewData['form'] = $form;
        $this->mViewData['status_list'] = $this->common_ref->status_list();
        $this->render('ref_charttype/ref_charttypes_update');
...
/* End of file Ref_charttype.php */
/* Location: ./application/controllers/Ref_charttype.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Custom Codeigniter CRUD Generator 2019-02-07 15:48:46 */