...
class Ref_recurrence extends Admin_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('Ref_recurrence_model');
    ...
    private $script = array(
        ...
        'assets/dist/admin/ref_recurrence.js',
    ); 
    ...
    public function index()
    {
        ...
        $this->mPageTitle = 'Informasi Referensi Tipe Kegiatan Berulang'; 
        $this->render('ref_recurrence/ref_recurrences_list');
    } 
    ...
    public function json() {
        ...
        */
        ...
        // if ($contractid !== '1')
        // {
        //     echo $this->Ref_recurrence_model->json($contractid);
        // }
        // else
        // {
            echo $this->Ref_recurrence_model->json();
        // }
    ...
    public function read($id)
    {
        ...
        $row = $this->Ref_recurrence_model->get_by_id($id);
        ...
        $this->mViewData['ref_recurrence'] = $data;
        $this->mPageTitle = 'Referensi Tipe Kegiatan Berulang';
        $this->mViewData['form'] = $form;
        $this->render('ref_recurrence/ref_recurrences_read');
    }
    ...
    public function delete($id) 
    {
        ...
        if ($row) {
            $this->Ref_recurrence_model->set_primary_key('id');
            $this->Ref_recurrence_model->delete($id);
            $this->Ref_recurrence_model->set_primary_key('id');
            $this->session->set_flashdata('message', 'Delete Record Success');
            redirect(site_url('admin/ref_recurrence'));
        } else {
    ...
    public function create()
    {
        ...
        if ($form->validate())
        {
    		...
    		$data = $this->Ref_recurrence_model->
        	insert(array
                (
        ...
        $this->mViewData['ref_recurrence'] = $this->Ref_recurrence_model->get_all();
        $this->mViewData['status_list'] = $this->common_ref->status_list();
        $this->mPageTitle = 'Registrasi Referensi Tipe Kegiatan Berulang';
        $this->mViewData['form'] = $form;
        $this->render('ref_recurrence/ref_recurrences_form');
    ...
    if ($row)
    {
        ...
        $this->mViewData['ref_recurrence'] = $data;
        $this->mViewData['status_list'] = $this->common_ref->status_list();
        $this->mPageTitle = 'Ubah Referensi Tipe Kegiatan Berulang';
        $this->mViewData['form'] = $form;
        $this->render('ref_recurrence/ref_recurrences_update');
...
/* End of file Ref_recurrence.php */
/* Location: ./application/controllers/Ref_recurrence.php */
/* Please DO NOT modify this information : */
/* Generated by Harviacode Custom Codeigniter CRUD Generator 2018-10-22 09:34:53 */