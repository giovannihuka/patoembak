...
class Leaflet
{
	...
	var $attribution = '© <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a>, Tiles courtesy of <a href="http://hot.openstreetmap.org/" target="_blank">Humanitarian OpenStreetMap Team</a>';
	
	// Map State Options
	var $center             ="-6.1753942, 106.8271830";
	var $setView			="[-2.5269749, 118.0148634],5"; // Indonesian Map
	var $fitBounds			= "";
	var $zoom               ="10";
	var $layers             ="";
	var $map_name 			="map";
	...
	function create_map() {
		...
		$this->output_js_contents .= '
			var map = L.map(\'map\').setView('.$this->setView.').fitBounds('.$this->fitBounds.');
			';
