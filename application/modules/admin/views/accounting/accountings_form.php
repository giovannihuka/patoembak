...
<div class="row">
    <div class="col-md-6">
        <div class="box box-primary">
            <div class="box-body">
                <?php echo $form->open(); ?>
				<?php echo $form->bs3_text('Pemasukan / Pengeluaran','in_out','','','','Masukkan Pemasukan / Pengeluaran'); ?>
				<?php echo $form->bs3_text('Jenis Pembayaran','category_id','','','','Masukkan Jenis Pembayaran'); ?>
				<?php echo $form->bs3_text('Nama Aktifitas','activity_id','','','','Masukkan Nama Aktifitas'); ?>
				<?php echo $form->bs3_date('Tanggal Aktifitas','activity_date','','','','Masukkan Tanggal Aktifitas'); ?>
				<?php echo $form->bs3_text('Jumlah','amount','','','','Masukkan Jumlah'); ?>
