...
<div class="row">
    <div class="col-md-6">
        <div class="box box-primary">
            <div class="box-body">
                <?php echo $form->open(); ?>
				<?php echo $form->bs3_text('Jenis Kelamin','gender_name','','','','Masukkan Jenis Kelamin'); ?>
            	...
            	<?php echo '<button type="reset" class="btn btn-default" onclick="location.href=\'ref_gender\'">Back to List</button>' ?>
            	<?php echo $form->close(); ?>
            </div>
        </div>
    </div>
